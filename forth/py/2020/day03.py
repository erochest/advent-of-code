...
TREE = '#'
INPUT_FILE = '../data/2020/day03.txt'
FIXTURE_FILE = '../sample/2020/day03.txt'
SLOPES = [
    (1, 1),
    (1, 3),
    (1, 5),
...
def main():
    f = partb if 'b' in sys.argv else parta
